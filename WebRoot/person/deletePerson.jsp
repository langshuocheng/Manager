...
<script src="http://cdn.bootcss.com/bootstrap/3.3.0/js/bootstrap.min.js"></script>
  ...
  <body>
	...
	<table  class="table table-striped">
        <thead><tr> <th>编号</th><th>姓名</th><th>性别</th><th>年龄</th><th>职位</th><th>入职时间</th><th>工作年限</th><th>删除 修改</th> </tr></thead>
        <tbody>
        <c:choose>
        	...
        	<c:forEach  items="${listPerson}" var="person">
         	<tr>
				...
				<a class="btn btn-primary btn-lg active" 
				 href="${pageContext.request.contextPath}/personService/toupdataPerson?pId=${person.pId}" ><span class="glyphicon glyphicon-wrench"></span>修改</a></td>
			</tr> 
        </c:forEach>
        </c:when>
        <c:otherwise>
